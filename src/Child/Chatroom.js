  ...
  return (
      ...
      <div>
         <div className="right-card" style={{maxhHeight:"100%"}}>
            ...
            <div style={{height:"80%"}}>
            <div className="card-bodyy pl-5 pr-5 pt-3" style={{maxHeight:'80%'}} >
               {messages.map(item => {
                  return <div style={{
                  ...
                  >
                     <p style={{
                        ...
                        ? 'linear-gradient(#f5594e, #d94d43, #c44239)'
                        : 'linear-gradient(#8a8a8a, #696969, #595959)',
                        color:'white',
                        display:'inline',
            ...
            <div className="card-footerr pb-3"style={{maxHeight:"10%", position:"fixed", width:"100%" , bottom:0, background:"white"}}>
               <div className="row">

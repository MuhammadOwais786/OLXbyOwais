    ...
    <div className="container mt-4">
      <div className="row">
        ...
        <div className="col-md-4">
          <div className="left-card card" style={{ height: '32rem' }}>
                  ...
                  return id !== userId && <li key={id} onClick={() => navigateToChat(id)}>
                    <div className="row chats">
                      ...
                      <div className="col-lg-10 col-md-10 col-sm-12 col-12 " style={{ cursor: "pointer" }}>
                        <span className="d-none d-md-block name" style={{ fontWeight: 700, color: "#142e2e" }}>{fullName}</span>
                        <p style={{ color: 'grey', fontSize: 13 }} className="name">It is your messages</p>
                      </div>
                    </div>
                  </li>
                })}
        ...
        <div className="col-md-8">
          <div className="right-card card" style={{ height: '32rem', marginLeft: -30 }}>
            <EmptyChat />
          </div>
        </div>
